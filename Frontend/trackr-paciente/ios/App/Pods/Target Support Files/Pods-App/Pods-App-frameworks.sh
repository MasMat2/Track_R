...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityFileOpener/CapacitorCommunityFileOpener.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorHealthDataPlugin/CapacitorHealthDataPlugin.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapawesomeCapacitorFilePicker/CapawesomeCapacitorFilePicker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapawesomeCapacitorScreenOrientation/CapawesomeCapacitorScreenOrientation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PerfoodCapacitorHealthkit/PerfoodCapacitorHealthkit.framework"
fi
