...
export class ContenidoExamenFormularioComponent implements OnInit {
  private readonly MENSAJE_AGREGAR: string = 'El contenido del examen ha sido agregado';
  private readonly MENSAJE_EDITAR: string = 'El contenido del examen ha sido modificado';
