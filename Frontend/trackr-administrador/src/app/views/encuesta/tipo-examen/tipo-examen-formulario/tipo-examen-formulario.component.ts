...
export class TipoExamenFormularioComponent implements OnInit {
  private readonly MENSAJE_AGREGAR: string = 'El Tipo Cuestionario ha sido agregado';
  private readonly MENSAJE_EDITAR: string = 'El Tipo Cuestionario ha sido modificado';
