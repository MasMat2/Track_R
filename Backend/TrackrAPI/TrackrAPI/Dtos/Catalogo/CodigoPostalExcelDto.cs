...
public class CodigoPostalExcelDto
{
    ...
    public string c_tipo_asenta { get; set; } = string.Empty;
    ...
    public string c_cve_ciudad { get; set; } = string.Empty;
}
}
