...
public class AsignaturaValidatorService
{
    ...
    private readonly string MensajeDependencia = "El Cuestionario tiene reactivos asociados y no se puede eliminar";

    private readonly string MensajeExistencia = "El Cuestionario que se requería actualizar no existe";

    private readonly string MensajeDuplicado = "El Cuestionario que intenta agregar ya existe";
